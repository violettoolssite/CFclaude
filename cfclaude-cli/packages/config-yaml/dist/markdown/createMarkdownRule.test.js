import { createMarkdownWithFrontmatter, createRuleMarkdown, sanitizeRuleName, } from "./createMarkdownRule.js";
...
describe("sanitizeRuleName", () => {
    ...
    it("should handle empty and edge case inputs", () => {
        ...
        expect(sanitizeRuleName("rule-with-numbers-123")).toBe("rule-with-numbers-123");
    });
});
...
Just markdown content.`;
    ...
    it("should create content that can be parsed back correctly", () => {
        ...
        const originalMarkdown = "# Roundtrip Test\n\nThis should parse back correctly.";
        const created = createMarkdownWithFrontmatter(originalFrontmatter, originalMarkdown);
...
//# sourceMappingURL=createMarkdownRule.test.js.map