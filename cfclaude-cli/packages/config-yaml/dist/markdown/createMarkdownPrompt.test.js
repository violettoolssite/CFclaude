import { createMarkdownWithPromptFrontmatter, createPromptMarkdown, } from "./createMarkdownPrompt.js";
...
describe("createPromptMarkdown", () => {
    test("should create properly formatted markdown with all options", () => {
        const result = createPromptMarkdown("Test Prompt", "This is the prompt content", {
            description: "A test prompt",
            invokable: true,
        });
        expect(result).toBe(`---
...
//# sourceMappingURL=createMarkdownPrompt.test.js.map