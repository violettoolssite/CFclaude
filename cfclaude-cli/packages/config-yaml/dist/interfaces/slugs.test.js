import { decodeFQSN, decodeFullSlug, decodePackageIdentifier, decodePackageSlug, encodeFQSN, encodeFullSlug, encodePackageIdentifier, encodePackageSlug, VirtualTags, } from "./slugs.js";
describe("PackageSlug", () => {
    ...
    it("should throw error for invalid FQSN format", () => {
        expect(() => decodeFQSN("owner1/package1/owner2/test-secret")).toThrow("Invalid FQSN format: package slug must have two parts");
    });
});
describe("PackageIdentifier", () => {
    ...
    it("should throw error for unknown URI type", () => {
        ...
        expect(() => encodePackageIdentifier(invalidIdentifier)).toThrow("Unknown URI type: invalid");
    });
...
//# sourceMappingURL=slugs.test.js.map