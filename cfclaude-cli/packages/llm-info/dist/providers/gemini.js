    ...
    models: [
        {
            ...
            description: "Google's flagship frontier model with high precision multimodal capabilities.",
        ...
        },
        {
            ...
            description: "Google's advanced model with strong reasoning, multimodal capabilities, and advanced coding skills",
            contextLength: 1048576,
            maxCompletionTokens: 65536,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Fast, token-efficient multimodal model for complex tasks with 1M context window",
            contextLength: 1048576,
            maxCompletionTokens: 65536,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Small, fast model with reduced latency and memory requirements",
            contextLength: 1048576,
            maxCompletionTokens: 8192,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Model with image generation capabilities and improved visual quality",
            contextLength: 32000,
            maxCompletionTokens: 8192,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Experimental version of Gemini 2.0 Flash with extended capabilities",
            contextLength: 1048576,
            maxCompletionTokens: 8192,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Smaller version of Gemini 1.5 Flash optimized for efficiency",
            contextLength: 1048576,
            maxCompletionTokens: 8192,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Mid-size multimodal model capable of handling extensive inputs and complex reasoning tasks",
