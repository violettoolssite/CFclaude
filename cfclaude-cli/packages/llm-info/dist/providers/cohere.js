    ...
    models: [
        {
            ...
            description: "Command A Translate is Cohere’s state of the art machine translation model, excelling at a variety of translation tasks on 23 languages",
            recommendedFor: ["chat"],
        },
        {
        ...
        },
        {
            ...
            maxCompletionTokens: 8192,
            description: "Command A Vision is Cohere's first model capable of processing images, excelling in enterprise use cases such as analyzing charts, graphs, and diagrams, table understanding, OCR, document Q&A, and object detection.",
            recommendedFor: ["chat"],
        },
        {
            ...
            contextLength: 256000,
            maxCompletionTokens: 8192,
            description: "Command A is Cohere’s most performant model to date, excelling at real world enterprise tasks including tool use, retrieval augmented generation (RAG), agents, and multilingual use cases.",
            recommendedFor: ["chat"],
        },
        {
            ...
            description: "Our state-of-the-art lightweight multilingual AI model has been optimized for advanced Arabic language capabilities to support enterprises in the MENA region.",
            recommendedFor: ["chat"],
        },
        {
            ...
            contextLength: 128000,
            maxCompletionTokens: 4096,
            description: "The smallest model in our R series delivers top-tier speed, efficiency, and quality to build powerful AI applications on commodity GPUs and edge devices.",
            recommendedFor: ["chat"],
        },
        {
        ...
        },
        {
            ...
            contextLength: 16000,
            maxCompletionTokens: 4096,
            description: "Aya Vision is a state-of-the-art multimodal and massively multilingual large language model excelling at critical benchmarks for language, text, and image capabilities.",
            recommendedFor: ["chat"],
        },
        {
        ...
        },
        {
            ...
            contextLength: 128000,
            maxCompletionTokens: 4096,
            description: "Aya Expanse is a massively multilingual large language model excelling in enterprise-scale tasks.",
            recommendedFor: ["chat"],
        },
        {
        ...
        },
        {
            ...
            description: "A model for documents and semi-structured data (JSON). State-of-the-art performance in English and non-English languages.",
        ...
        },
        {
            ...
            description: "A model for documents and semi-structure data (JSON) that are not in English.",
            recommendedFor: ["rerank"],
            contextLength: 4096,
        },
    ],
