...
import { convertVercelStreamPart, convertVercelStream, } from "../vercelStreamConverter.js";
...
describe("convertVercelStream", () => {
    ...
    test("converts stream of mixed events", async () => {
        ...
        expect(chunks[2].choices[0].delta.tool_calls?.[0].function?.name).toBe("test");
...
//# sourceMappingURL=vercelStreamConverter.test.js.map