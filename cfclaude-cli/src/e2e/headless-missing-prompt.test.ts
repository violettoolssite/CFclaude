...
models:
  - model: gpt-4
    ...
    expect(output).toContain('cf -p "please review my current git diff"');
    expect(output).toContain('echo "hello" | cf -p');
    expect(output).toContain('cf -p "analyze the code in src/"');
  });
